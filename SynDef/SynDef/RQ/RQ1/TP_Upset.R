...
setwd("D:/cursor code/SynDef/Upset/TP")


set_files <- c(
  "GLANCE-LR"           = "glancelr-TP.csv",
  "N-gram"              = "ngram-TP.csv",
  "PMD"                 = "PMD-TP.csv",
  "LineDP"              = "linedp-TP.csv",
  "DeepLineDP"          = "deeplinedp-TP.csv",
  "SynDef" = "SynDef-TP.csv",
  "LineDef"             = "linedef-TP.csv",
  "SPLICE-F"            = "splice-F-TP.csv"
)
...
png(
  filename = "TP_upset_8sets_top30.png",
  width = 10,
  height = 7,
  units = "in",
  res = 300
...
png(
  filename = "TP_upset_8sets_top40.png",
  width = 10,
  height = 7,
  units = "in",
  res = 300
...
png(
  filename = "TP_upset_8sets_top50.png",
  width = 10,
  height = 7,
  units = "in",
  res = 300
...
png(
  filename = "TP_upset_6sets_top30.png",
  width = 10,
  height = 7,
  units = "in",
  res = 300
...
png(
  filename = "TP_upset_6sets_top40.png",
  width = 10,
  height = 7,
  units = "in",
  res = 300
...
png(
  filename = "TP_upset_6sets_top50.png",
  width = 10,
  height = 7,
  units = "in",
  res = 300
...
if (!interactive()) {
  try(browseURL(normalizePath("TP_upset_8sets_top30.png")), silent = TRUE)
}
